...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-accent/5">
      <Helmet>
        <title>Mi Dashboard | PinCraft.pro</title>
        <meta name="description" content="Gestiona y descarga todos tus pines generados con PinCraft." />
        <link rel="canonical" href="https://pincraft.pro/dashboard" />
      </Helmet>
      <Header />
